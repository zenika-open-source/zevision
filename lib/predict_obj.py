...
def organize_object_prediction(output_dict,path_labels):
    ...
    for i in range(0,output_dict['num_detections']):
        ...
        one_prediction = {'category' : category, 'precision' : output_dict['detection_scores'][i],'boxes' : output_dict['detection_boxes'][i]}
...
output = organize_object_prediction(output_dict,PATH_TO_LABELS)
print(output)
